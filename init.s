...
.LM36:
	call	cons_init@PLT
	.stabn	68,0,44,.LM37-.LFBB2
.LM37:
	leaq	.LC2(%rip), %rdi
	movl	$6828, %esi
	xorl	%eax, %eax
	call	cprintf@PLT
	.stabn	68,0,47,.LM38-.LFBB2
.LM38:
	movl	$5, %edi
	call	test_backtrace
	.p2align 4,,10
...
.LFB2:
	...
	movaps	%xmm7, 192(%rsp)
.L18:
	.stabn	68,0,67,.LM41-.LFBB3
.LM41:
	movq	%fs:40, %rax
	movq	%rax, 24(%rsp)
	xorl	%eax, %eax
	.stabn	68,0,70,.LM42-.LFBB3
.LM42:
	cmpq	$0, panicstr(%rip)
	je	.L23
	.p2align 4,,10
...
.LM47:
	movl	%esi, %edx
	movq	%rdi, %rsi
	.stabn	68,0,77,.LM48-.LFBB3
.LM48:
	movl	$24, (%rsp)
	movq	%rax, 8(%rsp)
	leaq	32(%rsp), %rax
	.stabn	68,0,78,.LM49-.LFBB3
.LM49:
	leaq	.LC3(%rip), %rdi
	.stabn	68,0,77,.LM50-.LFBB3
.LM50:
	movq	%rax, 16(%rsp)
	.stabn	68,0,78,.LM51-.LFBB3
.LM51:
	xorl	%eax, %eax
	.stabn	68,0,77,.LM52-.LFBB3
.LM52:
	movl	$48, 4(%rsp)
	.stabn	68,0,78,.LM53-.LFBB3
.LM53:
	call	cprintf@PLT
	.stabn	68,0,79,.LM54-.LFBB3
.LM54:
	movq	%rbp, %rdi
	movq	%rsp, %rsi
	call	vcprintf@PLT
	.stabn	68,0,80,.LM55-.LFBB3
.LM55:
	leaq	.LC4(%rip), %rdi
	xorl	%eax, %eax
	call	cprintf@PLT
...
.LFB3:
	...
	movaps	%xmm7, 192(%rsp)
.L25:
	.stabn	68,0,92,.LM57-.LFBB4
.LM57:
	movq	%fs:40, %rax
	movq	%rax, 24(%rsp)
	xorl	%eax, %eax
	.stabn	68,0,95,.LM58-.LFBB4
.LM58:
	leaq	224(%rsp), %rax
...
.LM59:
	movq	%r10, %rsi
	movl	%r11d, %edx
	.stabn	68,0,95,.LM60-.LFBB4
.LM60:
	movq	%rax, 8(%rsp)
	leaq	32(%rsp), %rax
	.stabn	68,0,96,.LM61-.LFBB4
.LM61:
	leaq	.LC5(%rip), %rdi
	.stabn	68,0,95,.LM62-.LFBB4
.LM62:
	movq	%rax, 16(%rsp)
	.stabn	68,0,96,.LM63-.LFBB4
.LM63:
	xorl	%eax, %eax
	.stabn	68,0,95,.LM64-.LFBB4
.LM64:
	movl	$24, (%rsp)
	movl	$48, 4(%rsp)
	.stabn	68,0,96,.LM65-.LFBB4
.LM65:
	call	cprintf@PLT
	.stabn	68,0,97,.LM66-.LFBB4
.LM66:
	movq	%rbp, %rdi
	movq	%rsp, %rsi
	call	vcprintf@PLT
	.stabn	68,0,98,.LM67-.LFBB4
.LM67:
	xorl	%eax, %eax
	leaq	.LC4(%rip), %rdi
	call	cprintf@PLT
	.stabn	68,0,100,.LM68-.LFBB4
.LM68:
	movq	24(%rsp), %rax
	subq	%fs:40, %rax
	jne	.L28
